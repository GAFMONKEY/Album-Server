...
# Aufruf:   docker build --tag gruppe-5/album:2024.04.0-bookworm .
#               ggf. --progress=plain
#               ggf. --no-cache
...
# Aufruf Docker Scout
#     docker scout quickview gruppe-5/album:2024.04.0-bookworm
#     docker scout quickview gruppe-5/album:2024.04.0-distroless
#     docker scout quickview gruppe-5/album:2024.04.0-wolfi

#     docker scout cves gruppe-5/album:2024.04.0-bookworm
#     docker scout cves --format only-packages gruppe-5/album:2024.04.0-bookworm
...
LABEL org.opencontainers.image.title="album" \
    ...
    org.opencontainers.image.authors="ewlu1011@h-ka.de,gide1011@h-ka.de,rini1025@h-ka.de,sato1014@h-ka.de"
